...
CDdata = "/ReadyforAnalysis_2024-11-07.csv" # list of country data sets to be analyzed
...
complete_countries <- sort(c("Bangladesh","BurkinaFaso","Cambodia","CotedIvoire","Ghana","Jordan",
                             "Kenya","Lesotho","Mozambique","Nepal","Philippines","Senegal","Tanzania"))
...
master <- rbind(Bangladesh,BurkinaFaso,Cambodia,CotedIvoire,Ghana,Jordan,
                Kenya,Lesotho,Mozambique,Nepal,Philippines,Senegal,Tanzania)
...
# master$test <- 0
# master$test[master$anc1==1 & master$anc1timing==1 & master$anc4==1 & master$ancq==1 & master$ideliv==1] <- 1
# table(master$test)
